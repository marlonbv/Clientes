function gravaEstagioObra(id, descricao) {
    $.ajax({
        url: 'js/sqlscopeEstagioObra.php',
...
function recuperaEstagioObra(id) {
    $.ajax({
        url: 'js/sqlscopeEstagioObra.php', //caminho do arquivo a ser executado
        dataType: 'html', //tipo do retorno
        type: 'post', //metodo de envio
...
function excluirEstagioObra(id) {
    $.ajax({
        url: 'js/sqlscopeEstagioObra.php', //caminho do arquivo a ser executado
        dataType: 'html', //tipo do retorno
        type: 'post', //metodo de envio
