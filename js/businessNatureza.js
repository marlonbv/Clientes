function gravaNatureza(id, descricao) {
    $.ajax({
        url: 'js/sqlscopeNatureza.php',
...
function recuperaNatureza(id) {
    $.ajax({
        url: 'js/sqlscopeNatureza.php', //caminho do arquivo a ser executado
        dataType: 'html', //tipo do retorno
        type: 'post', //metodo de envio
