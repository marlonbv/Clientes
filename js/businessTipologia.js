function gravaTipologia(id, descricao) {
    $.ajax({
        url: 'js/sqlscopeTipologia.php',
...
function recuperaTipologia(id) {
    $.ajax({
        url: 'js/sqlscopeTipologia.php', //caminho do arquivo a ser executado
        dataType: 'html', //tipo do retorno
        type: 'post', //metodo de envio
