function gravaUnidade(id, empreendimento, bloco, vinculadas, matricula, unidade, andar, coluna, tipologia, posicaoSol, 
vistaUnidade, inscricaoPredial, jsonQuadroAreasArray, areaUtil, areaPrivada, areaComum, areaTotal) {
    $.ajax({
        url: 'js/sqlscopeUnidade.php',
        dataType: 'html', //tipo do retorno
        type: 'post', //metodo de envio
        data: {funcao: "grava", id: id, empreendimento: empreendimento, bloco: bloco, vinculadas: vinculadas, matricula: matricula, unidade: unidade,
            andar: andar, coluna:coluna, tipologia: tipologia, posicaoSol: posicaoSol, vistaUnidade: vistaUnidade,
            inscricaoPredial: inscricaoPredial, jsonQuadroAreasArray:jsonQuadroAreasArray,
            areaUtil:areaUtil, areaPrivada:areaPrivada, areaComum:areaComum, areaTotal:areaTotal}, //valores enviados ao script     
        beforeSend: function () {
