        ...
        <section id="widget-grid" class="">
            <div class="row" style="margin: 0 0 13px 0;">
                <?php if ($condicaoGravarOK) { ?>
                    <a class="btn btn-primary fa fa-file-o" aria-hidden="true" title="Novo" href="<?php echo APP_URL; ?>/tipologiaCadastro.php" style="float:right"></a>
                <?php } ?>    
            </div>                    
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formTipologiaFiltro" method="post">
...
<script>
    ...
    function listarFiltro() {
        var tipologiaFiltro = $('#tipologia').val();  
        
        if (tipologiaFiltro !== "") {
            tipologiaFiltro = tipologiaFiltro.replace(/^\s+|\s+$/g, "");
            tipologiaFiltro = encodeURIComponent(tipologiaFiltro);
        }
          
        var parametrosUrl = '&tipologiaFiltro=' + tipologiaFiltro ; 
        $('#resultadoBusca').load('tipologiaFiltroListagem.php?' + parametrosUrl);
    }
</script>    
