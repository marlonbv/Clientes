...
$condicaoExcluirOK = (in_array('ESTADOCIVIL_EXCLUIR', $arrayPermissao, true));
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formEstadoCivil" method="post">    
                                                    ...
                                                    <fieldset>
                                                        <div class="row">
                                                            ...
                                                            <section class="col col-4">
                                                                ...
                                                                <label class="input">
                                                                 <input  type="text" id="estadoCivil" name="estadoCivil" class="required" required/>
                                                                </label>            
                                                            </section>
                                                        </div>  
                                                    </fieldset> 
...
<script language="JavaScript" type="text/javascript"> 
    ...
    $(document).ready(function () { 
        ...
        $("#estadoCivil").on("change", function () {
         var idd = $("#estadoCivil").val();
                recuperaEstadoCivil(idd);
          
        });
        
        $('#estadoCivil').bind('keypress', apenasLetras);
