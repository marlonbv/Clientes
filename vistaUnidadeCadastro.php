...
$condicaoAcessarOK = (in_array('VISTAUNIDADE_ACESSAR', $arrayPermissao, true));
$condicaoGravarOK = (in_array('VISTAUNIDADE_GRAVAR', $arrayPermissao, true));
$condicaoExcluirOK = (in_array('VISTAUNIDADE_EXCLUIR', $arrayPermissao, true));
...
$page_nav["tabelasBasicas"]["sub"]["vistaUnidade"]["active"] = true;
                ...
                <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable centerBox">
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        <header>
                            ...
                            <h2>Vista da Unidade</h2>
                        </header>
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formVistaUnidade" method="post">    
                                                    ...
                                                    <fieldset>
                                                        <div class="row">
                                                            ...
                                                            <section class="col col-4">
                                                                ...
                                                                <label class="input"><i class="icon-prepend  fa fa-map-o"></i>
...
<script src="<?php echo ASSETS_URL; ?>/js/businessVistaUnidade.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript"> 
    ...
    function novo() {
        $(location).attr('href', 'vistaUnidadeCadastro.php');
    }

    function voltar() {
        $(location).attr('href', 'vistaUnidadeFiltro.php');
    }
    ...
    function gravar() {
        ...
        if ((descricao === 0) || (descricao === "")) {
                ...
                smartAlert("Atenção", "Informe a vista da unidade.", "error");
                $("#descricao").focus();
                return;
            }
        else {
             gravaVistaUnidade(id, descricao);
        } 
    }  
