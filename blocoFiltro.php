        ...
        <section id="widget-grid" class="">
            <div class="row" style="margin: 0 0 13px 0;">
                <?php if ($condicaoGravarOK) { ?>
                    <a class="btn btn-primary fa fa-file-o" aria-hidden="true" title="Novo" href="<?php echo APP_URL; ?>/blocoCadastro.php" style="float:right"></a>
                <?php } ?>    
            </div>                    
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formBlocoFiltro" method="post">
...
<script>
    ...
    function listarFiltro() {
        var blocoFiltro = $('#empreendimento').val();  
        
        if( blocoFiltro === ''){
             smartAlert("Erro", "Escolha um empreendimento!", "error");
        }
        
        if ((blocoFiltro !== "") & (blocoFiltro !== undefined)) {
            blocoFiltro = blocoFiltro.replace(/^\s+|\s+$/g, "");
            blocoFiltro = encodeURIComponent(blocoFiltro);
            
            var parametrosUrl = '&blocoFiltro=' + blocoFiltro ; 
             $('#resultadoBusca').load('blocoFiltroListagem.php?' + parametrosUrl);
        }
