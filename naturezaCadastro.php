...
$condicaoExcluirOK = (in_array('NATUREZA_EXCLUIR', $arrayPermissao, true));
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formNatureza" method="post">    
                                                    ...
                                                    <fieldset>
                                                        <div class="row">
                                                            ...
                                                            <section class="col col-4">
                                                                ...
                                                                <label class="input"><i class="icon-prepend  fa fa-leaf"></i>
...
<script src="<?php echo ASSETS_URL; ?>/js/businessNatureza.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript"> 
    ...
    function novo() {
        $(location).attr('href', 'naturezaCadastro.php');
    }

    function voltar() {
        $(location).attr('href', 'naturezaFiltro.php');
    }
    ...
    function gravar() {
        ...
        if ((descricao === 0) || (descricao === "")) {
                ...
                smartAlert("Atenção", "Informe a natureza.", "error");
                $("#descricao").focus();
                return;
            }
        else {
             gravaNatureza(id, descricao);
        } 
    }  
