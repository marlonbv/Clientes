...
$condicaoExcluirOK = (in_array('POSICAOUNIDADE_EXCLUIR', $arrayPermissao, true));
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formPosicaoUnidade" method="post">    
                                            ...
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseCadastro" class="" id="accordionCadastro">
                                                        ...
                                                        Cadastro de posições relativas a unidade
                                                    </a>
                                                </h4>
                                            </div>
...
<script src="<?php echo ASSETS_URL; ?>/js/businessPosicaoUnidade.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript"> 
    ...
    function novo() {
        $(location).attr('href', 'posicaoUnidadeCadastro.php');
    }

    function voltar() {
        $(location).attr('href', 'posicaoUnidadeFiltro.php');
    }
    ...
    function gravar() {
        ...
        if ((descricao === 0) || (descricao === "")) {
                ...
                smartAlert("Atenção", "Informe a Posição Relativa da Unidade!", "error");
                $("#descricao").focus();
                return;
            }
        else {
             gravaPosicaoUnidade(id, descricao);
        } 
    } 
