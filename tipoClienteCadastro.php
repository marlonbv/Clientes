...
$condicaoAcessarOK = (in_array('TIPOCLIENTE_ACESSAR', $arrayPermissao, true));
$condicaoGravarOK = (in_array('TIPOCLIENTE_GRAVAR', $arrayPermissao, true));
$condicaoExcluirOK = (in_array('TIPOCLIENTE_EXCLUIR', $arrayPermissao, true));
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formTipoCliente" method="post">    
                                                    ...
                                                    <fieldset>
                                                        <div class="row">
                                                            ...
                                                            <section class="col col-1">
                                                                ...
                                                                <label class="input">
                                                                    <input  type="text" maxlength="1" onkeyup="this.value = this.value.toLowerCase();" id="tipoCliente" name="tipoCliente" class="required" required/>
                                                                </label>       
                                                            </section>  
                                                            
                                                            <section class="col col-4">
                                                                <label class="label">Descrição do Tipo de Cliente</label>
                                                                <label class="input"><i class="icon-prepend  fa fa-vcard"></i>
...
<script src="<?php echo ASSETS_URL; ?>/js/businessTipoCliente.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript"> 
    ...
    $(document).ready(function () { 
        ...
        $('#tipoCliente').bind('keypress', apenasLetras);
        $('#descricao').bind('keypress', apenasLetras);
        
        $("#tipoCliente").on("change", function () {
         var idd = $("#tipoCliente").val();
                recuperaTipoClienteExistente(idd); 
        });
    ...
    function novo() {
        $(location).attr('href', 'tipoClienteCadastro.php');
    }

    function voltar() {
        $(location).attr('href', 'tipoClienteFiltro.php');
    }
    ...
    function gravar() {
        ...
        if ((descricao === 0) || (descricao === "")) {
                ...
                smartAlert("Atenção", "A descrição não pode estar vazia!", "error");
                $("#descricao").focus();
                return;
            }
        else if((tipoCliente === 0) || (tipoCliente === "")){
            
                smartAlert("Atenção", "A inicial do cliente não pode estar vazia!", "error");
                $("#tipoCliente").focus();
                return;
        }    
        else {
             gravaTipoCliente(id, tipoCliente, descricao);
        } 
    }  
