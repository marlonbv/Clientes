...
$condicaoExcluirOK = (in_array('QUADROAREAS_EXCLUIR', $arrayPermissao, true));
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formQuadroAreas" method="post">    
...
<script src="<?php echo ASSETS_URL; ?>/js/businessQuadroAreas.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript"> 
    ...
    function novo() {
        $(location).attr('href', 'quadroAreasCadastro.php');
    }

    function voltar() {
        $(location).attr('href', 'quadroAreasFiltro.php');
    }
    ...
    function gravar() {
        ...
        if ((descricao === 0) || (descricao === "")) {
                ...
                smartAlert("Atenção", "Informe o quadro de áreas.", "error");
                $("#descricao").focus();
                return;
            }
        else {
             gravaQuadroAreas(id, descricao);
        } 
    }  
