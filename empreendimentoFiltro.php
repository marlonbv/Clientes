        ...
        <section id="widget-grid" class="">
            <div class="row" style="margin: 0 0 13px 0;">
               <!-- <?php if ($condicaoGravarOK) { ?> -->
                    <a class="btn btn-primary fa fa-file-o" aria-hidden="true" title="Novo" href="<?php echo APP_URL; ?>/empreendimentoCadastro.php" style="float:right"></a>
                <?php } ?>    
            </div>                    
                ...
                <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable centerBox">
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        <header>
                            ...
                            <h2>Cadastro de empreendimentos</h2>
                        </header>
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formEmpreendimentoFiltro" method="post">
...
<script>
    ...
    function listarFiltro() {
        var empreendimentoFiltro = $('#empreendimento').val();  
        
        if (empreendimentoFiltro !== "") {
            empreendimentoFiltro = empreendimentoFiltro.replace(/^\s+|\s+$/g, "");
            empreendimentoFiltro = encodeURIComponent(empreendimentoFiltro);
        }
          
        var parametrosUrl = '&empreendimentoFiltro=' + empreendimentoFiltro ; 
        $('#resultadoBusca').load('empreendimentoFiltroListagem.php?' + parametrosUrl);
    }
</script>    
