...
$condicaoGravarOK = (in_array('POSICAOSOL_GRAVAR', $arrayPermissao, true));
$condicaoExcluirOK = (in_array('POSICAOSOL_EXCLUIR', $arrayPermissao, true));
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formPosicaoSol" method="post">    
...
<script src="<?php echo ASSETS_URL; ?>/js/businessPosicaoSol.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript"> 
    ...
    function novo() {
        $(location).attr('href', 'posicaoSolCadastro.php');
    }

    function voltar() {
        $(location).attr('href', 'posicaoSolFiltro.php');
    }
    ...
    function gravar() {
        ...
        if ((descricao === 0) || (descricao === "")) {
                ...
                smartAlert("Atenção", "Informe a posição do sol.", "error");
                $("#descricao").focus();
                return;
            }
        else {
             gravaPosicaoSol(id, descricao);
        } 
    } 
