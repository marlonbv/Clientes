                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <section class="col col-2">
                                                                ...
                                                                <label class="input">
                                                                    <input id="senha" maxlength="64" name="senha" type="password" class="required" value="">
                                                                </label>
                                                            </section>
                                                            <section class="col col-2">
                                                                <label class="label">Confirma Senha</label>
                                                                <label class="input">
                                                                    <input id="senhaConfirma" maxlength="64" name="senhaConfirma" type="password" class="required" value="">
                                                                </label>
                                                            </section>
                                                        </div>
                                                    </fieldset>
