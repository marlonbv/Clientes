...
$condicaoAcessarOK = (in_array('UF_ACESSAR', $arrayPermissao, true));
$condicaoGravarOK = (in_array('UF_GRAVAR', $arrayPermissao, true));
$condicaoExcluirOK = (in_array('UF_EXCLUIR', $arrayPermissao, true));
...
$page_nav["tabelasBasicas"]["sub"]["uf"]["active"] = true;
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formUf" method="post">    
                                                    ...
                                                    <fieldset>
                                                        <div class="row">
                                                             ...
                                                             <section class="col col-1">
                                                                ...
                                                                <label class="input">
                                                                    <input  type="text"  maxlength="2" onkeyup="this.value = this.value.toUpperCase();" id="sigla" name="sigla" class="required" required/>
                                                                </label>       
                                                            </section> 
                                                            ...
                                                            <section class="col col-4">
                                                                ...
                                                                <label class="input"><i class="icon-prepend  fa fa-globe"></i>
                                                                 <input  type="text" id="uf" name="uf" class="required" required/>
                                                                </label>            
                                                            </section>
                                                        </div>  
                                                    </fieldset> 
...
<script src="<?php echo ASSETS_URL; ?>/js/businessUf.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript"> 
    ...
    $(document).ready(function () { 
        ...
        $("#sigla").on("change", function () {
         var idd = $("#sigla").val();
                recuperaSigla(idd);
          
        });
        
        $('#uf').bind('keypress', apenasLetras);
        $('#sigla').bind('keypress', apenasLetras);
    ...
    function novo() {
        $(location).attr('href', 'ufCadastro.php');
    }
    
    function voltar() {
        $(location).attr('href', 'ufFiltro.php');
    }
